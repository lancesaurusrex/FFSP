...
namespace WebApplication1.Models {
    ...
    /// </summary>
    public class Drives {// Start\Key is the number of the drive -->Go back in and link Plays and PLayers to drives with class objs.
    ...
    public class Plays {//Start\Key is a number that I have not figured out what it means.
    ...
    public class Players {//The "Start"/Key of this JSONArray is the playerID, each one is different this could get complicated
        public int gameID { get; set; }
